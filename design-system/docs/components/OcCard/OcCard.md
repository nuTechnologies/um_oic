...
```html
<nu-card title="Card title"> Some content inside a card. </nu-card>
```
...
```html
<nu-card title="Card title" class="border" header-class="bg-gray-100 pb-4">
