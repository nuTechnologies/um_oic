...
```vue
<nu-text-input disabled label="Disabled" model-value="I am disabled" />
```
...
```vue
<nu-text-input class="mb-2" label="Text" />
<nu-text-input class="mb-2" read-only="true" label="Read only" value="I am read only" />
<nu-text-input class="mb-2" type="number" label="Number" />
<nu-text-input class="mb-2" type="email" label="Email" />
<nu-text-input class="mb-2" type="password" label="Password" />
```
