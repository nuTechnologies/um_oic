...
```html
<nu-spinner aria-label="Loading content" />
```
...
```html
<nu-spinner aria-label="Loading content" size="xsmall" />
<nu-spinner aria-label="Loading content" size="small" />
<nu-spinner aria-label="Loading content" size="medium" />
<nu-spinner aria-label="Loading content" size="large" />
<nu-spinner aria-label="Loading content" size="xlarge" />
<nu-spinner aria-label="Loading content" size="xxlarge" />
<nu-spinner aria-label="Loading content" size="xxxlarge" />
```
