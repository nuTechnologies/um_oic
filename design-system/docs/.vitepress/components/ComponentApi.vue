<template>
  ...
  <div v-if="isLoading" class="flex justify-center">
    <nu-spinner aria-label="Loading properties" />
  </div>
  <div v-else>
    <nu-table v-if="props.length" :fields="fields" :data="props" class="props-table">
      <template #type="{ item }">
        <code> {{ item.type }}</code>
      </template>
  ...
  <div v-if="isLoading" class="flex justify-center">
    <nu-spinner aria-label="Loading emits" />
  </div>
  <div v-else>
    <nu-table
      v-if="emits.length"
  ...
  <div v-if="isLoading" class="flex justify-center">
    <nu-spinner aria-label="Loading slots" />
  </div>
  <div v-else>
    <nu-table
      v-if="slots.length"
