...
export default defineConfig({
  title: 'xwork Design System',
  description: 'Design System for xwork',
  base: '/design-system/',
  appearance: false,
  ...
  themeConfig: {
    ...
    socialLinks: [
      {
        icon: 'github',
        link: 'https://github.com/xwork-eu/web/tree/main/packages/design-system'
      },
      {
        icon: 'matrix',
        link: 'https://app.element.io/#/room/#xwork:matrix.org'
      }
    ]
  },
  markdown: {
