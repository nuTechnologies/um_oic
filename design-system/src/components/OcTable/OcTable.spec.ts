import { shallowMount, mount, defaultPlugins } from '@xwork-eu/web-test-helpers'
...
describe('OcTable', () => {
  ...
  it('hides header', () => {
    ...
    expect(wrapper.findAll('nu-thead-stub').length).toBe(0)
  })
  ...
  it('enables hover effect', () => {
    ...
    expect(wrapper.attributes('class')).toContain('nu-table-hover')
  })
  ...
  it('adds sticky header', () => {
    ...
    expect(wrapper.attributes('class')).toContain('nu-table-sticky')
  })
  ...
  it('highlights a row', () => {
    ...
    expect(wrapper.findAll('.nu-table-highlighted').length).toEqual(1)
  })
  ...
  it('highlights multiple rows', () => {
    ...
    expect(wrapper.findAll('.nu-table-highlighted').length).toEqual(2)
  })
  ...
  it('accepts itemDomSelector closure', () => {
    ...
    data.forEach((item) => {
      expect(wrapper.find(['.nu-tbody-tr-custom', item.id].join('-')).exists()).toBeTruthy()
    })
  })
  ...
  it('emits contextmenu-clicked event upon right click on table row', async () => {
    ...
    await wrapper.find('.nu-tbody-tr').trigger('contextmenu')
