import { defaultPlugins, mount, shallowMount } from '@xwork-eu/web-test-helpers'
import OcSearchBar from './OcSearchBar.vue'

describe('OcSearchBar', () => {
  const selectors = {
    searchButton: '.nu-search-button',
    searchInput: '.nu-search-input',
    searchButtonWrapper: '.nu-search-button-wrapper',
    searchClearButton: '.nu-search-clear'
  }
  ...
  describe('small prop', () => {
    describe('when small is true', () => {
      ...
      it('should set small search grid', () => {
        expect(wrapper.attributes('class')).toContain('nu-search-small')
      })
      it('should set spinner size as xsmall', () => {
        const spinnerStub = wrapper.find('nu-spinner-stub')
    ...
    it('should set medium search grid and search button if not enabled', () => {
      ...
      expect(wrapper.attributes('class')).not.toContain('nu-search-small')
  ...
  describe('icon prop', () => {
    describe('when icon prop is not false', () => {
      ...
      it('should render icon', () => {
        const iconStub = wrapper.find('nu-icon-stub[name="mdi-icon"]')
  ...
  describe('loading prop', () => {
    describe('when loading', () => {
      ...
      it('should not show icon if loading', () => {
        const iconStub = wrapper.find('nu-icon-stub')
        expect(iconStub.exists()).toBeTruthy()
  ...
  describe('button hidden prop', () => {
    ...
    it('should add button class to input if disabled', () => {
      ...
      const searchInput = wrapper.find(selectors.searchInput)
      expect(searchInput.attributes('class')).toContain('nu-search-input-button')
    })
  })
  describe('aria-label for the loading spinner', () => {
    it('should add provided loading accessible label', () => {
      ...
      const spinnerEl = wrapper.find('nu-spinner-stub')
