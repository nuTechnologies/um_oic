import { defaultPlugins, mount, PartialComponentProps } from '@xwork-eu/web-test-helpers'
...
const selectors = {
  ...
  ocSpinner: '.nu-spinner',
  warningMessage: '.nu-text-input-warning',
  errorMessage: '.nu-text-input-danger',
  descriptionMessage: '.nu-text-input-description'
}
