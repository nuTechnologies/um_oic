<template>
  <span>
    <span
      ref="avatarsRef"
      v-nu-tooltip="tooltip"
      role="img"
      class="nu-avatars inline-flex w-fit flex-nowrap flex-row"
      :aria-label="avatarsAriaLabel"
      :class="{
        'nu-avatars-stacked [&>*]:not-first:-ml-3': stacked,
        'nu-avatars-hover-effect [&>*]:hover:!z-1000 [&>*]:hover:transform-[scale(1.1)] [&>*]:transition-transform [&>*]:duration-200 [&>*]:ease-out':
          hasHoverEffect,
    ...
    >
      ...
      <nu-avatar-count v-if="isOverlapping" :count="items.length - maxDisplayed" />
    </span>
