import { shallowMount, defaultPlugins, PartialComponentProps } from '@xwork-eu/web-test-helpers'
import OcColorInput from '../OcColorInput/OcColorInput.vue'

describe('OcColorInput', () => {
  const selectors = {
    inputField: '.nu-color-input',
    inputMessage: '.nu-color-input-message span',
    descriptionMessage: '.nu-color-input-description',
    errorMessage: '.nu-color-input-danger'
  }
