...
const selectors = {
  filterChipBtn: '.nu-filter-chip-button',
  filterChipLabel: '.nu-filter-chip-label',
  filterChipDrop: '.nu-filter-chip-drop',
  filterChipBtnActive: '.nu-filter-chip-button-selected',
  clearBtn: '.nu-filter-chip-clear'
}
