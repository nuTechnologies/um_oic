<template>
  <nu-text-input
    ...
    class="nu-date-picker"
    :class="{ 'nu-date-picker-dark': isDark }"
  />
</template>
...
@layer components {
  .nu-date-picker input::-webkit-calendar-picker-indicator {
    @apply cursor-pointer;
  }

  .nu-date-picker-dark input {
    color-scheme: dark;
  }

  .nu-date-picker-dark input::-webkit-calendar-picker-indicator {
    filter: invert(0);
  }
}
</style>
