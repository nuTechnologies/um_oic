<template>
  <div :class="$attrs.class">
    ...
    <div class="relative">
      <nu-icon v-if="readOnly" name="lock" size="small" class="mt-2 ml-2 absolute" />
      <component
        :is="inputComponent"
        :id="id"
        ...
        class="nu-text-input nu-input"
        :class="{
          'nu-text-input-danger border-role-error': !!showErrorMessage,
          'pl-6': !!readOnly,
      ...
      <nu-button
        ...
        class="pr-2 absolute top-[50%] transform-[translateY(-50%)] right-0 nu-text-input-btn-clear"
        appearance="raw"
        no-hover
        @click="onClear"
      >
    ...
    <div
      ...
      class="nu-text-input-message flex align-center text-sm mt-1 min-h-4.5"
      :class="{
        'nu-text-input-description text-role-on-surface-variant relative': showDescriptionMessage,
        'nu-text-input-danger text-role-error focus:text-role-error border-role-error':
          showErrorMessage
      }"
    >
      <template v-if="showErrorMessage">
        ...
        <span
          v-if="showErrorMessage"
          :id="messageId"
          class="nu-text-input-danger text-role-error focus:text-role-error border-role-error"
          v-text="errorMessage"
        />
      </template>
      <span
        ...
        :id="messageId"
        class="nu-text-input-description text-role-on-surface-variant flex items-center relative"
