<template>
  <div class="nu-contextual-helper inline-block">
    <nu-button
      :id="buttonId"
      ...
      no-hover
    >
      <nu-icon name="question" fill-type="line" size="small" />
    </nu-button>
    <nu-info-drop :drop-id="dropId" :toggle="toggleId" v-bind="props" />
  </div>
</template>
...
const dropId = ref(uniqueId('nu-contextual-helper-'))
