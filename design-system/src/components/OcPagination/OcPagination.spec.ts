...
const selectors = {
  listItemPage: '.nu-pagination-list-item-page',
  listItemCurrent: '.nu-pagination-list-item-current',
  listItemPrevious: '.nu-pagination-list-item-prev',
  listItemNext: '.nu-pagination-list-item-next',
  listItemEllipsis: '.nu-pagination-list-item-ellipsis',
  listItemLink: '.nu-pagination-list-item-link'
}
